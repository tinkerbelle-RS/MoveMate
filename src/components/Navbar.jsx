...
export default function Navbar() {
  ...
  const linkClass = (path) => `inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold transition ${location.pathname === path ? 'bg-brand-700 text-white' : 'text-slate-600 hover:bg-slate-100 hover:text-slate-950'}`;
