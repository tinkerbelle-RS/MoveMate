...
export function getMockAnalysis() {
  return normalizeAnalysis({
    ...
    renter_history_tips: [
      'Pay rent by the 1st each month and save confirmation receipts for future applications.',
      'Photo-document the unit at move-in and move-out to protect your deposit and reputation.',
      'Give 60-day written notice before lease end and keep proof for landlord references.',
      'Log repair requests in writing and follow up until they are resolved.',
    ],
  });
}
